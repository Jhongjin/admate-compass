...
const COMPASS_OFFICIAL_CHUNK_SNAPSHOTS: Record<string, CompassOfficialChunkSnapshotRow> = {
  ...
  kakao_moment_product_overview_2026_chunk_0: {
    ...
    chunk_id: 0,
    content: '카카오모먼트는 카카오의 대표 광고 플랫폼이며 카카오 비즈보드, 디스플레이 광고, 동영상 광고, 메시지 광고 등을 직접 집행할 수 있습니다. 카카오톡과 카카오 핵심 서비스, 주요 파트너 서비스 지면에 노출하고, 맞춤타겟과 데모그래픽 등 오디언스 설정을 활용합니다.',
    metadata: {
      source: '카카오모먼트',
      ...
      source_vendor: 'KAKAO',
      keywords: ['카카오모먼트', '비즈보드', '디스플레이 광고', '동영상 광고', '메시지 광고'],
      chunk_type: 'text',
      chunk_index: 0,
      hierarchy_level: 'paragraph',
    },
  ...
  naver_searchad_overview_powerlink_brand_2026_chunk_0: {
    ...
    chunk_id: 0,
    content: '네이버 검색광고는 파워링크, 쇼핑검색, 브랜드검색, 플레이스검색광고 등 검색광고 상품을 제공합니다. 검색 사용자의 검색어와 연관된 광고를 노출하고, 예산 설정과 클릭당 과금 방식, 보고서와 로그 분석을 통한 효과 분석을 함께 제공합니다.',
    metadata: {
      ...
      source_vendor: 'NAVER',
      keywords: ['파워링크', '쇼핑검색', '브랜드검색', '검색광고', '클릭당 과금'],
      chunk_type: 'text',
      chunk_index: 0,
      hierarchy_level: 'paragraph',
    },
