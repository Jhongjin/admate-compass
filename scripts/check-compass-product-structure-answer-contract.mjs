...
if (!/COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION = 'v25-meta-google-lead-capi-crm-webhook'[\s\S]*`compass-answer:\$\{COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION\}:\$\{message\}`/.test(answerHandler)) {
