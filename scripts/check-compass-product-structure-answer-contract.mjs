...
if (!/COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION = 'v32-simple-product-asset-history-limit'[\s\S]*`compass-answer:\$\{COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION\}:\$\{message\}`/.test(answerHandler)) {
