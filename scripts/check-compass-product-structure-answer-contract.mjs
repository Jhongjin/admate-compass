...
if (!/COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION = 'v22-meta-product-planning-matrix-decision-table'[\s\S]*`compass-answer:\$\{COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION\}:\$\{message\}`/.test(answerHandler)) {
