...
for (const snippet of [
  ...
  '전후사진',
  '상담 신청 폼',
  'v46-multi-vendor-policy-review',
...
if (!/COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION = 'v46-multi-vendor-policy-review'[\s\S]*`compass-answer:\$\{COMPASS_ANSWER_RESPONSE_CACHE_KEY_VERSION\}:\$\{message\}`/.test(answerHandler)) {
