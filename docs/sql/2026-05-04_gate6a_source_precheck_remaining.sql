-- Gate 6A source precheck remaining checks for Admate_AI_Bot.
...
select 'link_quality' as section, 'ollama_document_chunks_linked_to_documents' as check_name,
  count(d.id)::text || '/' || count(*)::text as value
